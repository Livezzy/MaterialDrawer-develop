...
import com.mikepenz.materialdrawer.app.entity.UpdateUserProfileResponse;
import com.mikepenz.materialdrawer.app.entity.User;
import com.mikepenz.materialdrawer.app.entity.UserAddress;
import com.mikepenz.materialdrawer.app.entity.updateProfileRequest;
...
public class AddressActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showBackButton();
        setActonBarTitleBar("My Address");
...
//        }
    ...
    private void saveAddress() {
        ...
        if (UserManager.getInstance().isUserAddressExists()) {
            userAddresses = user.getUserAddresss();
...
//        userAddress.setFlatNo(flat_house_office);
        ...
        user.setUserAddresss(userAddresses);
    ...
    protected void onResume() {
        ...
        if (UserManager.getInstance().isUserAddressExists()) {
            _userAddresses = UserManager.getInstance().getUser().getUserAddresss();
        ...
        JsonObjectRequest req = new JsonObjectRequest(URL, model, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                if (updateProfileResponse.isSuccess) {
                    UserManager.getInstance().saveUser(updateProfileResponse.getUser(), AddressActivity.this);
                    if (_isProceedToCheckOut) {
                        finish();
                    } else {
                        AddressActivity.this.updateView(AddressFunction.AddressListing);
                    }
                }
